...
class CellularEnv(Env):
    ...
    def step(self, action):
        ...
        #self.reward_rate = (self.counter/self.Nbs)*sumrate
        ...
        #print('Ejemplo de SINR \n', self.SINR[(self.episode_length * self.Nbs):(self.episode_length * self.Nbs) + self.Nbs])
        #print('Ejemplo de recompensa \n', self.rates[(self.episode_length * self.Nbs):(self.episode_length * self.Nbs) + self.Nbs])
        #print('Ejemplo de potencia \n', self.power[(self.episode_length * self.Nbs):(self.episode_length * self.Nbs) + self.Nbs])
        #print('Potencia minima\n', self.Pmin)
        #print('Potencia maxima\n', self.Pmax)
        #print('Estado de potencia \n', self.P_)

        #print('Ejemplo del estado:', self.state)
    ...
    def reset(self):
        ...
        # State formating ----------------------------------------------------------
        #print('State after reseting')
        #print(channel_state)
        #print(10*np.log10(power_state)+30)
        #print(reward_state)
        #wait=input('Press enter to continue')
        # self.P_= action
        # self.R_ = reward
